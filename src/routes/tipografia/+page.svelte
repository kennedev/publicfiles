<script>
  ...
  // Carregar o conteúdo do arquivo Tipografia
  onMount(async () => {
    const res = await fetch('/src/content/tipografia.md');
...
<div class="container">
  ...
  <h1>Tipografia</h1> <!-- Título da página Tipografia -->
  ...
  <pre class="tipografia-content">{content}</pre>
</div>
