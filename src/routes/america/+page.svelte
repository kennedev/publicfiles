<script>
  ...
  // Carregar o conteúdo do arquivo America
  onMount(async () => {
    const res = await fetch('/src/content/america.md');
...
<div class="container">
  ...
  <h1>America</h1> <!-- Título da página America -->
  ...
  <pre class="america-content">{content}</pre>
</div>
